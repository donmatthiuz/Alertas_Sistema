...
import HorizontalRadioGroup from "@/components/ui/HorizontalRadioGroup.js"

export default function Modal_Expresion({open, setOpen}) {
  const [isDropdownOpen, setIsDropdownOpen] = useState(false);


  const defaultOptions = [
    { id: 1, nombre: "Texto Plano", valor: "text" },
    { id: 2, nombre: "Regex", valor: "regex" },
  ];
                ...
                <div className="sm:flex sm:items-start">
                  <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                    ...
                    <div className={`mt-4 ${isDropdownOpen ? 'pb-16' : 'pb-4'} transition-all duration-300`}>
                      <Input
                        placeholder="Escriba  el nombre de la expresion"
                        />
                    </div>

                    <div className={`mt-4 ${isDropdownOpen ? 'pb-16' : 'pb-4'} transition-all duration-300`}>
                      <Input
                        placeholder="Escriba  la expresion"
                    ...
                    <div className={`mt-4 ${isDropdownOpen ? 'pb-16' : 'pb-4'} transition-all duration-300`}>
                      <Input
                        placeholder="Escriba  el uso que se la dara"
                        />
                        ...
                        <HorizontalRadioGroup
                            ...
                            title="Seleccione el tipo de expresion"
